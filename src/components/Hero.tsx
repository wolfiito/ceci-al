    ...
    <div className="relative h-[100svh] w-full overflow-hidden flex flex-col justify-center items-center bg-transparent">
      ...
      <div className="relative z-10 w-full text-center flex flex-col items-center justify-center h-full pb-20">
        <div className="flex flex-col items-center leading-[0.8] md:leading-[0.85] drop-shadow-lg">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: EASE_LUXURY, delay: 0.3 }}>
             <motion.h1 variants={floatingVariant} animate="float" className="font-serif text-[20vw] md:text-[9vw] text-white mix-blend-overlay opacity-90">{name1}</motion.h1>
             <motion.h1 variants={floatingVariant} animate="float" className="font-serif text-[20vw] md:text-[9vw] text-[#F2F0E9] absolute top-0 left-0 w-full pointer-events-none">{name1}</motion.h1>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: EASE_LUXURY, delay: 0.5 }}>
            <motion.h1 variants={floatingVariant} animate="float" transition={{ delay: 0.5 }} className="font-serif text-[20vw] md:text-[9vw] text-[#F2F0E9]">{name2}</motion.h1>
          </motion.div>
        </div>
