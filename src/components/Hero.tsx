...
export default function Hero() {
  // Nota: Al estar en position: fixed en page.tsx, ya no necesitamos 
  // lógica compleja de parallax aquí para que se quede quieto, 
  // pero podemos mantener animaciones de entrada.
